...
// FTO		$pdf->MultiCell($widthrecbox, $hautcadre, "", 0, 'R', 1);
			$pdf->SetTextColor(0,0,60);

			// Show sender name
			$pdf->SetXY($posx+2,$posy+3);
			$pdf->SetFont('','B', $default_font_size);
// FTO		$pdf->MultiCell($widthrecbox-2, 4, $outputlangs->convToOutputCharset($this->emetteur->name), 0, 'L');
			$posy=$pdf->getY();

			// Show sender information
			$pdf->SetXY($posx+2,$posy);
			$pdf->SetFont('','', $default_font_size - 1);
// FTO		$pdf->MultiCell($widthrecbox-2, 4, $carac_emetteur, 0, 'L');
...
// FTO		$pdf->Rect($posx, $posy, $widthrecbox, $hautcadre);
			...
			$pdf->SetXY($posx+2,$posy+3);
			$pdf->SetFont('','B', $default_font_size);
// FTO		$pdf->MultiCell($widthrecbox, 2, $carac_client_name, 0, 'L');
